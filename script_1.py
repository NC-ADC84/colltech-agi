# Let's rename the directory and update all references to CollTech-AGI
import os
import shutil

print("🔄 UPDATING PROJECT TO COLLTECH-AGI")
print("=" * 50)

# Check if sovereign-agi directory exists
if os.path.exists("sovereign-agi"):
    print("📁 Found sovereign-agi directory, renaming to colltech-agi...")
    
    # If colltech-agi already exists, remove it first
    if os.path.exists("colltech-agi"):
        shutil.rmtree("colltech-agi")
        print("  Removed existing colltech-agi directory")
    
    # Rename the directory
    shutil.move("sovereign-agi", "colltech-agi")
    print("✅ Directory renamed: sovereign-agi → colltech-agi")
else:
    # Create the directory structure if it doesn't exist
    os.makedirs("colltech-agi", exist_ok=True)
    print("📁 Created colltech-agi directory")

# Now create the updated README.md with CollTech-AGI branding
...
with open("colltech-agi/README.md", "w") as f:
    f.write(readme_content)

print("✅ Created README.md with CollTech-AGI branding")
print("✅ Project successfully renamed to CollTech-AGI")
print("✅ Maintains Sovereign stack technology foundation")